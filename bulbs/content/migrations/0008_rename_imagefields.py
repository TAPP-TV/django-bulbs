...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column("content_content", "image", "old_image")
        db.rename_column("content_content", "_image", "image")

    def backwards(self, orm):

        db.rename_column("content_content", "image", "_image")
        db.rename_column("content_content", "old_image", "image")
    ...
    models = {
        ...
        u'content.content': {
            ...
            'old_image': ('bulbs.images.fields.RemoteImageField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
