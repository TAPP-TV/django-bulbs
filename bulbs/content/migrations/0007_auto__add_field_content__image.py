...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content._image'
        db.add_column(u'content_content', '_image',
                      self.gf('betty.cropped.fields.ImageField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content._image'
        db.delete_column(u'content_content', '_image')
    ...
    models = {
        ...
        u'content.content': {
            ...
            '_image': ('betty.cropped.fields.ImageField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('bulbs.images.fields.RemoteImageField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
        ...
        u'content.logentry': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'change_logs'", 'null': 'True', 'to': u"orm['accounts.User']"})
        },
        u'content.tag': {
