...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Content.old_image'
        db.delete_column(u'content_content', 'old_image')


    def backwards(self, orm):
        # Adding field 'Content.old_image'
        db.add_column(u'content_content', 'old_image',
                      self.gf('bulbs.images.fields.RemoteImageField')(max_length=512, null=True, blank=True),
                      keep_default=False)
